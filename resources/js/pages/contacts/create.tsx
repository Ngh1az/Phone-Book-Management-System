...
import { Group, Tag } from '@/types/contact';
...
export default function ContactCreate({ groups, tags }: ContactCreateProps) {
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Tạo một liên hệ mới trong danh bạ của bạn
                        </p>
                    </div>
                        ...
                        <div className="space-y-6 md:col-span-2">
                            ...
                            <div className="flex justify-end gap-4">
                                ...
                                <Button type="submit" disabled={processing}>
                                    ...
                                    {processing ? 'Đang lưu...' : 'Lưu liên hệ'}
                                </Button>
                            </div>
                        </div>
                    </div>
